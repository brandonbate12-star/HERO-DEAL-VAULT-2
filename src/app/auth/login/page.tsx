        ...
        <div className="glass-card p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-hero-dark-card text-gray-400">or sign in with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-gray-400 mt-6 text-sm">
            ...
            <Link href="/auth/signup" className="text-hero-purple hover:text-hero-purple-light">
              Sign up
            </Link>
          </p>
        </div>
